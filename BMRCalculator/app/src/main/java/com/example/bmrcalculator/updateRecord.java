...
public class updateRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (it != null) {
            ...
            if (bundle != null) {
                String inputoldname = bundle.getString("oldname");
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(updateRecord.this, MainActivity.class);
    ...
    private synchronized  void  insertRecord(HashMap<String, String> map) {
        Thread thread = new Thread((new Runnable() {
            ...
            @Override
            public void run() {
                String path = "http://10.0.2.2/BMRCalculator/updateData.php";
